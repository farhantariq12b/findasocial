...
class Navbar extends React.Component {
  ...
  togglePopup() {
    if (this.state.showPopup == false) {
      document.getElementById("finda-social-banner__container").style.width = "100%"
    } else {
      document.getElementById("finda-social-banner__container").style.width = "90%"
    }
      ...
      <div>
        ...
        <div className="finda-social-navbar">
          ...
          <div className="mob-menu">
            <a href="#">
              <img onClick={this.togglePopup.bind(this)} src="/static/assets/images/mob-icon.svg" />
            </a>
          </div>
